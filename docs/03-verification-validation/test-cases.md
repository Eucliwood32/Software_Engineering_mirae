...
| TC-ID | P | L | 입력 | 기대 | 근거 |
| :-- | :- | :- | :-- | :-- | :-- |
| TC-FR-4.2-01 | P0 | L1 | `cap(5000)` | `(1000, True)` | 상한 |
| TC-FR-4.2-02 | P0 | L1 | `cap(999)` | `(999, False)` | 미발동 |
| TC-FR-4.2-03 | P0 | L1 | `cap(1000)` | `(1000, False)` (경계: `>`만 cap) | 경계 |
| TC-FR-4.2-04 | P0 | L1 | `cap(1001)` | `(1000, True)` | 경계 직상 |
